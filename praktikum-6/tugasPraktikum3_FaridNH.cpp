        ...
        switch (program)
        {
            ...
            case 2:
                { 
                        ...
                        while (j >= 0) {                                            // Cara kerja dari algoritma ini
                            if (nilai > nilai_terbesar[j]) {                        // adalah dengan memindahkan elemen
                                if (j < N - 1) {                                    // dari nilai[0..N-1] saat melebihi
                                    ...
                                    index_terbesar[j + 1] = index_terbesar[j];                                                // dari nilai_terbesar, ke satu posisi
                                }                                                   // didepan posisi awal elemen itu.
                                nilai_terbesar[j] = nilai;
                                index_terbesar[j] = i;                              // Sampai semua element terurut.
                            }
                    ...
                    cout << "\n" << "Nilai terbesar ke-" << N << " adalah " << nilai_terbesar[N - 1] << " di indeks " << index_terbesar[N - 1] << endl;
                }
                ulang = true;
                break;
